...
class PromptAssembler:
    ...
    def build_static(self) -> str:
        parts = [
            "You are WpCLI, a powerful AI coding assistant running in a terminal.",
    ...
    def _static_project_instructions(self) -> str:
        paths = [
            ...
            Path(self.cwd) / ".wpcli" / "AGENTS.md",
            Path(self.cwd) / "PAI.md",
            Path(self.cwd) / ".wpcli" / "PAI.md",
            Path(self.cwd) / "PAI.local.md",
            Path(self.cwd) / ".wpcli" / "PAI.local.md",
        ]
