...
from wpcli.entrypoints.repl import (
...
def test_banner_renders_w_home_layout():
    stream = StringIO()
...
def test_text_deltas_render_as_markdown_on_turn_complete():
    ...
    renderer.handle({"type": "text_delta", "text": "你好，我是 **Wp"})
