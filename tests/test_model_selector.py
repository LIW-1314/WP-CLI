...
from wpcli.entrypoints.model_selector import ModelSelectorState
from wpcli.entrypoints.repl import _activate_model
...
def test_activate_model_rebuilds_live_client_without_restart(tmp_path, monkeypatch):
    ...
    assert "You are WpCLI" in agent.system_prompt
